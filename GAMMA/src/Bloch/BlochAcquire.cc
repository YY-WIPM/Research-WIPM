...
**	                         G A M M A 				**
**						 			**
**	Bloch Acquisition Module                   Implementation	**
**						 			**
**      Copyright (c) 2001                                              **
**      Dr. Scott A. Smith             					**
...
#ifndef   BlochAcq_cc_			// Is file already included?
#  define BlochAcq_cc_ 1		// If no, then remember it
#  if defined(GAMPRAGMA)		// Using the GNU compiler?
#    pragma implementation		// This is the implementation
#  endif

#include <Bloch/BlochAcquire.h>		// Include the interface
